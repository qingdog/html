...
| `center`        | 弹性盒子沿主轴**居中**排序                             |
| `space-between` | 弹性盒子沿主轴均匀排序，空白间距均分再弹性盒子**之间** |
| `space-around`  | 弹性盒子沿主轴均匀排序，空白间距均分再弹性盒子**两侧** |
| `space-evenly`  | 弹性盒子沿主轴均匀排序，弹性盒子与容器之间间距**相等** |
...
| `center`   | 弹性盒子沿侧轴**居中**排序                                   |
| flex-start | 弹性盒子从起点开始依次排序                                   |
...
> 注意：该属性对**单行**弹性盒子模型**无效**。 因与 `flex-wrap: wrap;` 一起使用。
